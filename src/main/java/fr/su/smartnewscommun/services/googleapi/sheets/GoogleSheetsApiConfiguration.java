 ...
 */
@ConditionalOnProperty(prefix = "google", name = "api.sheets.scopes")
public class GoogleSheetsApiConfiguration {
    ...
    public Sheets sheetsService() {
        ...
        return new Sheets.Builder(httpTransportBuilder.build(), JSON_FACTORY, setHttpTimeout(this.googleCredential))
    ...
    private HttpRequestInitializer setHttpTimeout(final HttpRequestInitializer requestInitializer) {
        return new HttpRequestInitializer() {
            ...
            public void initialize(HttpRequest httpRequest) throws IOException {
                ...
                httpRequest.setConnectTimeout(GoogleSheetsApiConfiguration.this.connectTimeout);
                httpRequest.setReadTimeout(GoogleSheetsApiConfiguration.this.readTimeout);
            }
        };
    }
